...
class k2bsspSection {
	...
	public function create_content() {
		...
		new InputField( 'services_twitter_status', '<b>Twitter Button anzeigen</b>', 'k2bssp_tw', '<code>on</code>, wenn aktiviert, andernfalls <code>off</code>', '', 'checkbox' );
		new InputField( 'services_twitter_tweet_text', 'Tweet-Text', 'k2bssp_tw', 'Der übergebene Texte <code>de_DE</code>er auf 120 Zeichen gekürzt und beim letzten Leerzeichen mit &hellip; ersetzt.');
		new InputField( 'services_twitter_display_name', 'Anzeigename', 'k2bssp_tw', 'Schreibweise des Service in den Optionen' );
		new InputField( 'services_twitter_txt_info', 'Info-Text', 'k2bssp_tw', 'MouseOver-Text des Empfehlen-Buttons' );
		...
		new InputField( 'services_gplus_status', '<b>Google+-Button anzeigen</b>', 'k2bssp_gp', '<code>on</code>, wenn aktiviert, andernfalls <code>off</code>', '', 'checkbox');
		new InputField( 'services_gplus_display_name', 'Anzeigename', 'k2bssp_gp', 'Schreibweise des Service in den Optionen' );
		new InputField( 'services_gplus_txt_info', 'Info-Text', 'k2bssp_gp', 'MouseOver-Text des Empfehlen-Buttons' );
